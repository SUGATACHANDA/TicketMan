...
export default function Ticket({ ticketId }: { ticketId: Id<"tickets"> }) {
    ...
    const verifyTicket = `${process.env.NEXT_PUBLIC_FRONTEND_URL}/verify-ticket/${ticket?._id}`
            ...
            <div className="p-6">
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col items-center justify-center border-l border-gray-200 pl-6">
                        ...
                        >
                            {!location.match('verify-ticket') ? <QRCode value={verifyTicket} className="w-32 h-32" /> :
                                ""}
                        </div>
