        ...
        <div>
            <Form action={"/search"} className="relative">
                <input
                    ...
                    className="w-full py-3 px-4 pl-12 bg-white rounded-xl border shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 border-gray-200"
                />
